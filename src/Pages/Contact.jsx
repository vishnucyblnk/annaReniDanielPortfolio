...
function Contact() {
    ...
    const handleMail = ()=>{
        ...
        return `https://mail.google.com/mail/?view=cm&fs=1&to=annareni07@gmail.com&su=Contacting Anna Reni Daniel by ${username}&body=Name: ${username}%0D%0AEmail: ${email}%0D%0AMessage: ${message}`;
    ...
    return (
        <>
            ...
            <h6 className='fs-5 text-black'>Feel free to connect with me on LinkedIn or reach out via email at <span className='fw-bold' style={{color:'#4b4b4b'}}>annareni07@gmail.com</span>.</h6>
